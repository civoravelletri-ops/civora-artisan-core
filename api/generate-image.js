...
// URL CORRETTO dell'API di Hugging Face (con la dicitura /hf-inference/)
    // Usiamo runwayml/stable-diffusion-v1-5 che è lo standard d'oro gratuito per modificare foto (img2img)
    const HF_API_URL = 'https://router.huggingface.co/hf-inference/models/runwayml/stable-diffusion-v1-5';
