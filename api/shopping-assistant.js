...
export default async function handler(req, res) {
    ...
    // HO POTENZIATO IL PROMPT: ORA È OBBLIGATO A FARNE 3.
    ...
    FORMATO JSON OBBLIGATORIO (L'ARRAY 'carrelli' DEVE AVERE ESATTAMENTE 3 OGGETTI):
    {
      "carrelli":[
        ...
        {
          "nome": "Spesa Completa",
          "descrizione": "Un'ottima selezione equilibrata con tutto ciò che serve.",
          "prodotti":[
            { "productId": "ID", "variantId": "ID_VAR", "productName": "Nome", "qty": 2, "price": 5.00 }
          ]
        },
        {
          "nome": "Spesa Premium",
          "descrizione": "Per non farsi mancare nulla: la nostra selezione top.",
          "prodotti":[
            { "productId": "ID", "variantId": "ID_VAR", "productName": "Nome", "qty": 1, "price": 20.00 }
          ]
        }
      ]
    }`;
