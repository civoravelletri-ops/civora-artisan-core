...
export default async function handler(req, res) {
    ...
    try {
        ...
        const GOOGLE_API_KEY = process.env.GOOGLE_API_KEY; // Potrebbe essere utile per Gemimi Vision se Groq non fosse sufficiente, ma useremo Groq per multimodale.
        ...
        switch (type) {
            ...
            case 'consult_chat_final_prompt':
                ...
                if (type === 'consult_chat_message' && latestMessage) {
                    chatMessagesForGroroq.push({ role: 'user', content: latestMessage });
                }
