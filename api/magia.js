export default async function handler(req, res) {
    ...
    // Prepariamo le istruzioni per l'IA (Tono differenziato tra i vari settori)
    let systemPrompt = "";
    ...
    // === NUOVA LOGICA: STIMA PESO E DIMENSIONI (SPEDIZIONE CON IMPRONTA A TERRA) ===
