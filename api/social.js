export default async function handler(req, res) {
    ...
    res.setHeader('Access-Control-Allow-Credentials', true);
        res.setHeader('Access-Control-Allow-Origin', 'https://localmente-site.web.app'); 
        res.setHeader('Access-Control-Allow-Origin', 'https://localmente-v3-core.firebaseapp.com');
